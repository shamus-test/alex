		...
		$('.product_list > div > div').each(function(index, element) {
			...
			html = '<div class="product-container">';
				...
				html += '<div class="center-block col-xs-4 col-xs-7 col-md-8">';
					...
					html += '<div class="functional-buttons hidden clearfix">' + $(element).find('.functional-buttons').html() + '</div>';
					html += '<div class="button-container hidden">'+ $(element).find('.button-container').html() +'</div>';
	...
	else 
	{
		...
		html += '<div class="product-container clearfix">';
			...
			html += '<div class="right-block">';
				...
				html += '<div itemprop="offers" itemscope itemtype="http://schema.org/Offer" class="button-container hidden">'+ $(element).find('.button-container').html() +'</div>';
			html += '</div>';
		html += '</div>';		
		$(element).html(html);
		});
...
$(document).ready(function($) {
	...
	$(".product-guide #guide").click(function() {
	  $.fancybox({	   
	   'autoDimensions': true,
	   'content': '<embed src="'+this.href+'#nameddest=self&page=1&view=FitH,0&zoom=80,0,0" />',
	   'onClosed': function() {
