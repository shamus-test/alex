<div id="opc_new_account" class="opc-main-block">
	...
	<form action="{$link->getPageLink('authentication', true, NULL, "back=order-opc")|escape:'html':'UTF-8'}" method="post" id="login_form" class="block box form-horizontal">
		<fieldset>
	...
	<form action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" method="post" id="new_account_form" class="std form-horizontal" autocomplete="on" autofill="on">
		<fieldset>
        	<div class="box block">
				...
				{if !$dniExist}
				<div class="required dni form-group">
					<label class="control-label col-sm-4 col-md-6" for="dni">{l s='Identification number'} <sup>*</sup></label>
					<div class="col-sm-6 col-md-6">
						<input type="text" class="text form-control validate" name="dni" id="dni" data-validate="isDniLite" value="{if isset($guestInformations) && isset($guestInformations.dni) && $guestInformations.dni}{$guestInformations.dni}{/if}" />
						<span class="form_info">{l s='DNI / NIF / NIE'}</span>
					</div>
