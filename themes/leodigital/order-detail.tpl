...
*}
<div class="box box-small clearfix block">
{if isset($order)}
...
<div class="info-order box block">
...
<div class="adresses_bloc">
	<div class="row">
		<div class="col-xs-12 col-sm-6 col-md-6"{if $order->isVirtual()} style="display:none;"{/if}>
			<ul class="address alternate_item box block">
		...
		<div class="col-xs-12 col-sm-6 col-md-6">
			<ul class="address item {if $order->isVirtual()}full_width{/if} box block">
