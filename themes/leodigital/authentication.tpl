...
{if !isset($email_create)}
	...
	<div class="row">
		<div class="col-xs-12 col-sm-6 col-md-6">
			<form action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" method="post" id="create-account_form" class="box block">
		...
		<div class="col-xs-12 col-sm-6 col-md-6">
			<form action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" method="post" id="login_form" class="box block">
		...
		<form action="{$link->getPageLink('authentication', true, NULL, "back=$back")|escape:'html':'UTF-8'}" method="post" id="new_account_form" class="std clearfix form-horizontal">
			<div class="box block">
				<div id="opc_account_form" style="display: block; ">
					...
					{if isset($newsletter) && $newsletter}
						<div class="form-group">
							<div class="col-sm-offset-4 col-sm-8 col-md-8 col-md-offset-4">
								<div class="checkbox">
									<label class="col-sm-8 col-md-8" for="newsletter">
						...
						<div class="form-group">
							<div class="col-sm-offset-4 col-sm-8 col-md-8 col-md-offset-4">
								<div class="checkbox">
									<label class="col-sm-8 col-md-8" for="optin">
					...
					<div class="form-group">
						<div class="col-sm-offset-4 col-sm-7 col-md-offset-4 col-md-7">
							<div class="checkbox">
								<label class="col-sm-8 col-md-8" for="invoice_address">
...
{else}
	...
	{/if}-->
	<form action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" method="post" id="account-creation_form" class="std box block form-horizontal">
		...
		{if isset($PS_REGISTRATION_PROCESS_TYPE) && $PS_REGISTRATION_PROCESS_TYPE}
			<div class="account_creation">
				...
				{if isset($one_phone_at_least) && $one_phone_at_least}
					<div class="inline-infos"><label class="col-sm-offset-4 col-sm-6 col-md-6 col-sm-offset-4">{l s='You must register at least one phone number.'}</label></div>
				{/if}
				<div class="form-group">
