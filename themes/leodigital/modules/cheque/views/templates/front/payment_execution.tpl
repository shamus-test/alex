...
{else}
	...
	<form action="{$link->getModuleLink('cheque', 'validation', [], true)|escape:'html':'UTF-8'}" method="post">
		<div class="box cheque-box block">
		...
		<p class="cart_navigation clearfix" id="cart_navigation">
			<a href="{$link->getPageLink('order', true, NULL, "step=3")|escape:'html':'UTF-8'}" class="btn btn-default button">
				<span><i class="icon-chevron-left"></i>{l s='Other payment methods' mod='cheque'}</span>
			</a>
