...
<ul class="display hidden hidden-xs">
	<span class="display-title">{l s='Display:'}</span>
    <li id="grid"><a title="{l s='Grid'}" href="#" rel="view-grid"><i class="icon-th-large" ></i></a></li>
    <li id="list"><a  title="{l s='List'}" href="#"  rel="view-list"><i class="icon-th-list"></i></a></li>
