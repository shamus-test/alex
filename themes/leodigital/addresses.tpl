...
<div class="addresses">
	...
	{foreach from=$multipleAddresses item=address name=myLoop}
    	<div class="col-xs-12 col-sm-6 col-md-6 address">
			<ul class="{if $smarty.foreach.myLoop.last}last_item{elseif $smarty.foreach.myLoop.first}first_item{/if} {if $smarty.foreach.myLoop.index % 2}alternate_item{else}item{/if} box block">
...
<ul class="footer_links clearfix">
	<li class="pull-left"><a href="{$link->getPageLink('my-account', true)|escape:'html':'UTF-8'}"><span><i class="icon-user"></i> {l s='Back to your account'}</span></a></li>
	<li class="pull-right"><a href="{$base_dir}"><span><i class="icon-home"></i> {l s='Home'}</span></a></li>
</ul>