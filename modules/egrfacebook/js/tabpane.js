...
function commlimit()
{
	if(document.getElementById("cmt3").checked == true)
		document.getElementById("cmli").style.display ="";
	else
		document.getElementById("cmli").style.display ="none";
}
function confirmation(x)
{
	var answer = confirm("Are you sure you want to capture?")
	if (answer){
		x.submit();
	}
	
}
function confirmation2(x)
{
